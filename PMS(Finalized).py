...
def Base_Page():
    ...
    icon=PhotoImage(file="vit-logo.png")
    logo=Label(root,image=icon)
    PMS=Label(root,text="Parking Management System",font=("Helvetica", 45))
...
def Login_Page():
    ...
    PMS=Label(Login_GUI,text="      Parking Management System",font=("Helvetica", 45))
    logo.grid(row=1,column=0)
    PMS.grid(row=1,column=2,columnspan=3)
    ...
    pswd.grid(row=3,column=3)
    lab3.grid(row=4)
    Login_Button.grid(row=5,column=2)
    NewUser_Button.grid(row=5,column=3)
    Login_GUI.mainloop()
...
def NewUser_Page():
    ...
    PMS=Label(NewUser_GUI,text="      Parking Management System",font=("Helvetica", 45))
    logo.grid(row=1,column=0)
    ...
    lab5=Label(NewUser_GUI,text="Mobile No :",padx=20,pady=5,font=("Times New Roman",23))
    ...
    Hostel.grid(row=4,column=2)
    G1.grid(row=5,column=2)
    G2.grid(row=5,column=3)
    Mobile.grid(row=6,column=2)
    Email.grid(row=7,column=2)
    UserName.grid(row=8,column=2)
    Pass.grid(row=9,column=2)

    lab10=Label(NewUser_GUI,text="",font=("Times New Roman",28))
    lab10.grid(row=10)
    Submit_Button=Button(NewUser_GUI,text="Submit",command=DB_Reg,font=("Times New Roman",23),bd=3)
...
def User_Page():
    ...
    PMS=Label(User_GUI,text="Parking Management System",font=("Helvetica", 45))
    logo.grid(row=1,column=0)
    PMS.grid(row=1,column=1,columnspan=4)

    icon1=PhotoImage(file="booknow.png")
    Book=Label(User_GUI,image=icon1)
    BookParking_Button=Button(User_GUI,text="Book Parking",font=("Times New Roman",20),bd=3,command=Book_Page)

    icon2=PhotoImage(file="Policy.png")
    Policy=Label(User_GUI,image=icon2)
    Policy_Button=Button(User_GUI,text="Parking Policy",font=("Times New Roman",20),bd=3,command=ParkingPolicy)

    icon3=PhotoImage(file="logout.png")
    Logout=Label(User_GUI,image=icon3)
    Logout_Button=Button(User_GUI,text="Logout",font=("Times New Roman",20),bd=3,command=UptoBp)

    icon4=PhotoImage(file="parkingdetails.png")
    Y=Label(User_GUI,text="Registration No.",font=("Times New Roman",20),padx=20,pady=5)
    global Z
    Z=Entry(User_GUI,font=("Times New Roman",28))
    Details=Label(User_GUI,image=icon4)
    Details_Button=Button(User_GUI,text="Details",font=("Times New Roman",20),bd=3,command=De)
    
    Book.grid(row=2,column=1)
    BookParking_Button.grid(row=3,column=1)
    Policy.grid(row=2,column=2)
    Policy_Button.grid(row=3,column=2)
    Logout.grid(row=2,column=3)
    Logout_Button.grid(row=3,column=3)
    Details.grid(row=2,column=4)
    Y.grid(row=3,column=4)
    Z.grid(row=4,column=4)
    Details_Button.grid(row=5,column=4)
    User_GUI.mainloop()
    User_GUI.mainloop()
...
# VIT Logo & Heading
    ...
    icon=PhotoImage(file="vit-logoDetails.png")
    logo=Label(SuperUser_GUI,image=icon)
    PMS=Label(SuperUser_GUI,text="Parking Management System",font=("Helvetica", 40))
